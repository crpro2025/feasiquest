...
function searchHelp() {
    ...
    const articles = document.querySelectorAll('.article-item, .help-card, .faq-item');
...
// Show article (placeholder - would load full article)
function showArticle(articleId) {
    showNotification('Article viewer coming soon! This would open: ' + articleId, 'info');
}
